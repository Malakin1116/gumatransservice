...
export default function TiresCatalog() {
  ...
  const applyFiltersAndSort = (values = { size: '', brand: '', axle: '' }) => {
    let filtered = tires.filter((tire) => !tire.type || tire.type === 'ШИНА');
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-bold mb-4">Каталог шин</h1>
      <div className="mb-6">
        <Link href="/catalog/disks" className="text-blue-600 hover:underline text-sm">
